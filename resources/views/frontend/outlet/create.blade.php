...
<script>
  function createBarang() {
    ...
    axios.post('http://localhost:8000/api/outlet', data)
      .then(function(response) {
        console.log(response.data); // Tampilkan respon dari API jika berhasil
        alert('outlet berhasil dibuat'); // Tampilkan pesan sukses
      ...
      .catch(function(error) {
        ...
        alert('Gagal membuat outlet. Silakan coba lagi.'); // Tampilkan pesan error
      });
  }
</script>
